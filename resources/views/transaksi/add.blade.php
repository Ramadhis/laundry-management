...
@section('konten')
  <form method="POST" name="add" action="{{route('transaksi.store')}}">
    @csrf
    <div class="form-group row">
      <label class="col-sm-2 col-form-label form-label">Id Member</label>
      <div class="col-sm-4">
        <input type="text" class="form-control" id="memberid" name="member" placeholder="member" required>
      </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="number" min="1" max="10" class="form-control" name="qty" placeholder="Qty" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <textarea type="number" class="form-control" name="ket" placeholder="Keterangan" required>
          </textarea>
      </div>
    </div>
    <div class="form-group row">
